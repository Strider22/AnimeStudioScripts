...
ScriptName = "msGroupToLayerTransform2"
msGroupToLayerTransform2 = {}
msGroupToLayerTransform2.matrix = LM.Matrix:new_local()

-- **************************************************
-- This information is displayed in help | About scripts ... 
-- **************************************************
function msGroupToLayerTransform2:Name()
	return "GroupToLayerTransform2 ... "
end

function msGroupToLayerTransform2:Version()
	return "1.0"
end

function msGroupToLayerTransform2:Description()
	return MOHO.Localize("/Scripts/Menu/MinimalScript/Description=Removes transform from group and applies it to sub layers.")
end

function msGroupToLayerTransform2:Creator()
...
-- **************************************************
function msGroupToLayerTransform2:UILabel()
	return(MOHO.Localize("/Scripts/Menu/GroupToLayerTransform2/GroupToLayerTransform2=GroupToLayerTransform2 ... "))
end



function msGroupToLayerTransform2:TransformCurve(curve, translation, scale, rotX, rotY, rotZ)
...
function msGroupToLayerTransform2:TransformAllCurves(vectorLayer, translation, scale, rotX, rotY, rotZ)
...
function msGroupToLayerTransform2:RemoveLayerTransformation(layer)
...
function msGroupToLayerTransform2:TransformLayer(layer, translation, scale, rotX, rotY, rotZ, moho)
...
function msGroupToLayerTransform2:SelectLayer(layer, moho)
...
-- **************************************************
function msGroupToLayerTransform2:Run(moho)
